...
public class MixedITCase
{
    ...
    @Test
    public void jaxwscommons81_wsimport()
        throws IOException
    {
        ...
        assertFilePresent( project,
                           "target/generated-sources/wsimport/org/jvnet/jax_ws_commons/wsimport/test/HelloWs_Service.java" );
                           // this needs to be fixed as there should be a way to not generate sources
                           // assertFileNotPresent(project,
                           // "target/jaxws/wsimport/org/jvnet/jax_ws_commons/wsimport/test/HelloWs.java");
        ...
        // -wsdlLocation
        assertFileContains( project, "target/custom/sources/org/jvnet/jaxwsri/sample/MyGreeter.java",
                            "http://example.com:43210/my?wsdl" );
        // default dependency on JDK version
        assertFileContains( project, "target/custom/sources/org/jvnet/jaxwsri/sample/GreetersPortT.java",
                            "JAX-WS RI " + version );
        // -target 2.0
        assertFileContains( project, "target/custom/sources/org/jvnet/jaxwsri/sample/GreetersPortT.java",
        ...
        assertFileContains( project, "target/custom/sources/org/jvnet/jaxwsri/sample/GreetersPortT.java",
                            ...
                            // assertFileContains(project,
                            // "target/custom/sources/org/jvnet/jaxwsri/sample/EchoType.java", "import
        ...
        assertFileContains( project, "target/generated-sources/test-wsimport/wsimport/test/SumUtil.java",
                            "JAX-WS RI " + version );
    }

    @Test
    public void jaxwscommons81_wsgen()
        throws IOException
    {
        project = new File( PROJECTS_DIR, "jaxwscommons-81" );
        String version = getExpectedToolsVersion();
        ...
        // check EchoService
        assertFilePresent( project,
                           "target/custom/sources/org/jvnet/jax_ws_commons/jaxws/test/jaxws/EchoResponse.java" );
        ...
        assertFilePresent( project,
                           "target/test-classes/org/jvnet/jax_ws_commons/jaxws/test/jaxws/HelloResponse.class" );
        assertFilePresent( project,
                           "target/generated-sources/test-wsgen/org/jvnet/jax_ws_commons/jaxws/test/jaxws/HelloResponse.java" );
        assertFileNotPresent( project, "target/test-classes/org/jvnet/jax_ws_commons/jaxws/test/TService.java" );
        assertFileNotPresent( project,
                              "target/test-classes/org/jvnet/jax_ws_commons/jaxws/test/jaxws/HelloResponse.java" );
        // default dependency on JDK version
        ...
        // -servicename
        assertFileContains( project, "target/generated-sources/test-wsdl/ExService.wsdl",
